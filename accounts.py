...
EXPENSE_RULES: list[tuple[list[str], str]] = [
    (["etc", "高速", "駐車", "パーキング", "タクシー", "jr", "新幹線", "鉄道", "バス", "航空", "ana", "jal", "定期", "交通系", "乗車券"], "旅費交通費"),
...
# 諸口は給与などの複合仕訳を1行ずつに分けるときの相手科目（会計事務所の運用）。
BS_ACCOUNTS = {
    "現金", "当座預金", "普通預金", "定期預金", "定期積金", "受取手形",
    "売掛金", "前渡金", "前払費用", "立替金", "仮払金",
    "支払手形", "買掛金", "未払金", "未払費用", "長期未払金", "短期借入金", "長期借入金",
    "役員借入金", "前受金", "預り金", "仮受金", "事業主貸", "事業主借", "諸口",
}
